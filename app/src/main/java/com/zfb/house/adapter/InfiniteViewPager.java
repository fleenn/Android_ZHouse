...
//        Log.i("InfiniteViewPager", msg);
    ...
    private static final long DEFAULT_AUTO_SCROLL_INTERVAL = 4000;//4s
    ...
    private int xTouchSlop;// 标示x滑动的最小距离
    private int lastX;
    private int lastY;
    ...
    void init() {
        xTouchSlop = ViewConfiguration.get(getContext()).getScaledTouchSlop();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                int distance = (int) (ev.getX() - lastX);
//                int yDistance = (int) (ev.getY() - lastY);
                if (Math.abs(distance) >= xTouchSlop) {
    ...
    public static class FakePositionHelper {
        ...
        public static int getRealPositon(InfiniteViewPager viewPager, int position) {
            ...
            realAdapterSize = realAdapterSize == 0 ? 1 : realAdapterSize;
