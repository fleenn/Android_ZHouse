...
import com.zfb.house.ui.BrokerShopRentDetailActivity;
...
public class RentAdapter extends RecyclerView.Adapter {
    ...
    public List<RentItem> getmData() {
        return mData;
    }

    public void setmData(List<RentItem> mData) {
        this.mData = mData;
    }

    public RentAdapter(Context mContext, UserBean userBean, List<RentItem> models, SettingOperationView.OnOperationClickListener onOperationClickListener, LoadMoreRecyclerView loadMoreRecyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final RentItem model = mData.get(position);
        brokersHolder.rl_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hideSettingView();
                Intent intent = new Intent(mContext, BrokerShopRentDetailActivity.class);
        ...
        //设置出租的字段
        brokersHolder.tv_shop_type.setText(ToolUtil.setRentType(model));
        //面积
        ...
        //租金
        if (!ParamUtils.isEmpty(model.getRental())) {
            brokersHolder.tv_shop_price.setText(model.getRental() + "元/月");
        }
    ...
    private class BrokersHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_shop_price;//租金
        RelativeLayout rl_parent;//item
