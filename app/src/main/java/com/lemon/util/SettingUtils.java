...
public final class SettingUtils {
    ...
    public static void set(Context context, int resId, double value) {
        set(context, context.getString(resId), value);
    }
    ...
    public static void set(Context context, String key, double value) {
        SharedPreferences prefs = PreferenceManager
                .getDefaultSharedPreferences(context);
        Editor editor = putDouble(prefs.edit(), key, value);
        commitOrApply(editor);
    }

    public static double get(Context context, int resId, double defValue) {
        return get(context, context.getString(resId), defValue);
    }

    public static double get(Context context, String key, double defValue) {
        SharedPreferences prefs = PreferenceManager
                .getDefaultSharedPreferences(context);
       return getDouble(prefs,key,defValue);
    }
