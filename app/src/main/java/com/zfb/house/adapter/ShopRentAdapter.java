 ...
 * 版本:      [v1.0]
 */
public class ShopRentAdapter extends BaseAdapter {

    private List<RentItem> models;
    ...
    public ShopRentAdapter(Handler handler, Context context, UserBean userBean,
                           List<RentItem> models, SettingOperationView.OnOperationClickListener onOperationClickListener) {
    ...
    public List<RentItem> getModels() {
        return models;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final RentItem model = models.get(position);
        if (convertView == null) {
        ...
        holder.rl_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideSettingView();
                Intent intent = new Intent(context, BrokerShopRentDetailActivity.class);
        ...
        if (!ParamUtils.isEmpty(model.getPhoto())) {
            ...
            GlideUtil.getInstance().loadUrl(context, "", holder.iv_shop_img);
        }
        //标题
        ...
        if (!ParamUtils.isEmpty(model.getRental())) {
            holder.tv_shop_price.setText(model.getRental() + "元/月");
        }
        return convertView;
    }
