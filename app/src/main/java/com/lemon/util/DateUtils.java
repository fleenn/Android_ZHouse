...
public final class DateUtils {
    ...
    public static int compare(String dateStr1, String dateStr2)
            throws Exception {
        return new SimpleDateFormat(yyyyMMDD).parse(dateStr1).compareTo(new SimpleDateFormat(yyyyMMDD).parse(dateStr2));
    }
     ...
     * @return
     */
    public static double compare(long dateStr1, long dateStr2){
       return (dateStr1-dateStr2)/60000;
    }
    /**
     * 将Date类型转换为日期字符串
     *
